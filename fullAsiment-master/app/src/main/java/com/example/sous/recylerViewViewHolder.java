...
what=m;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.text5.setText("Age="+data[4][position]);
        holder.text6.setText("DepartmentID="+data[5][position]);
...
TextView text1,text2,text3,text4,text5,text6;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            text5=itemView.findViewById(R.id.Age);
            text6=itemView.findViewById(R.id.DepartmentID);
        }
    }
}
